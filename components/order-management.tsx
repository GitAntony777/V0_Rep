...
import { Plus, Eye, Edit, Trash2, Printer, MapPin } from "lucide-react"
  ...
  return (
    <div className="space-y-6">
      <Card>
        ...
        <CardContent>
          <OrderFilters onSearch={handleSearch} onDateSelect={handleDateSelect} />
        </CardContent>
      </Card>
      ...
      <Dialog open={showOrderForm} onOpenChange={setShowOrderForm}>
        <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>Δημιουργήστε μια νέα παραγγελία για την εορταστική περίοδο</DialogDescription>
          </DialogHeader>
        ...
        <Dialog open={showMapsDialog} onOpenChange={setShowMapsDialog}>
          <DialogContent className="max-w-4xl max-h-[80vh]">
            <DialogHeader>
              ...
              <DialogDescription>
                Διεύθυνση: {selectedOrder.customerAddress} - Τηλέφωνο: {selectedOrder.customerPhone}
              </DialogDescription>
            </DialogHeader>
            <GoogleMapsIntegration address={selectedOrder.customerAddress} />
          </DialogContent>
        </Dialog>
      )}
    </div>
